...
void MainComponent::paint (juce::Graphics &g)
{
    ...
    if (settingsPannel.getShowPose() == true && settingsPannel.getShowOrientation() == true)
    {
    ...
    else if (settingsPannel.getShowPose() == true && settingsPannel.getShowOrientation() == false)
    {
...
void MainComponent::resized()
{
    ...
    if (settingsPannel.getShowOrientation() == true)
    {
        orientation.setBounds (settingsPannel.getX(),
                               settingsPannel.getBottom() + 5,
                               settingsPannel.getWidth(),
...
void MainComponent::AboutMyoMapperDialogWindow()
{
    ...
    RectanglePlacement placement (RectanglePlacement::xMid | RectanglePlacement::yMid | RectanglePlacement::doNotResize);
    
    Rectangle<int> result (placement.appliedTo (area,
